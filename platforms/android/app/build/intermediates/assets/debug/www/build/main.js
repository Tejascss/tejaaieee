...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.loadUsers = function (size, pageNumber) {
        var _this = this;
        this.http.get('https://randomuser.me/api/?results=' + size + '&page=' + pageNumber).map(function (res) { return res.json(); }).subscribe(function (data) {
            console.log(data);
            for (var i = 0; i < data.results.length; i++) {
                _this.usersList.push(data.results[i]);
            }
        });
    };
    HomePage.prototype.doInfinite = function (infiniteScroll) {
        ...
        this.page_no += 1;
        setTimeout(function () {
            _this.loadUsers(_this.listSize, _this.page_no);
            infiniteScroll.complete();
        }, 500);
    };
    HomePage.prototype.dateConverter = function (date) {
        var d = new Date(date);
        var day = d.getDate();
    ...
    HomePage.prototype.myValue = function (date) {
        var d = new Date(date);
        var day = d.getDate();
        var month = d.getMonth();
        var year = d.getFullYear();
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"F:\ionic-projects\AIEE\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      AIEE\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n    <ion-list>\n      <ion-item *ngFor="let user of usersList">\n          <ion-grid>\n            <ion-row>\n              <ion-col>\n                  <ion-title><span>{{user.name.title}}.</span><span>{{user.name.first}}</span> &nbsp;<span>{{user.name.last}} </span></ion-title>\n              </ion-col>\n            </ion-row>\n            <ion-row>\n                <ion-col>\n                  Registered on:  {{myValue(user.registered.date)}}\n                </ion-col>\n                <ion-col>\n                    Age: {{user.registered.age}}\n                </ion-col>\n            </ion-row>\n            </ion-grid>\n             <div style="padding-left:10px;">Location: {{user.location.street}},{{user.location.city}} </div>\n            </ion-item>\n    </ion-list>\n   \n    <ion-infinite-scroll (ionInfinite)="doInfinite($event)">\n      <ion-infinite-scroll-content></ion-infinite-scroll-content>\n    </ion-infinite-scroll>\n   \n   </ion-content>\n'/*ion-inline-end:"F:\ionic-projects\AIEE\src\pages\home\home.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__angular_http__ = __webpack_require__(249);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"F:\ionic-projects\AIEE\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"F:\ionic-projects\AIEE\src\app\app.html"*/
        }),
